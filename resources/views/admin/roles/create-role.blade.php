          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form method="post" action="{{ url('/admin/save-role') }}" enctype="multipart/form-data">
                  @csrf
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                          <div class="form-group">
                                              <label>Role</label>
                                              <input name="role" placeholder="Role" value="{{ old('role') }}" class="form-control @error('role') is-invalid @enderror">
                                              ...
                                              <div class="accordion-body collapse show" id="{{ $module->id}}panel" data-parent="#accordion">
                                                  ...
                                                  @foreach($module->pages as $key => $page)
                                                      <div class="" style="margin-left: 20px;">
                                                          <input class="form-check-input" name="admin_module_page_id[]" type="checkbox" value="{{ $page->id }}" id="{{ $page->id }}" data-module-id="{{ $module->id }}">
          ...
          function Allselect(event) {
              ...
              for (var i = 0; i < checkboxes.length; i++) {
                  ...
                  if (checkboxes[i].checked) {
                      checkboxes[i].checked = false; // If checked, uncheck it
                  } else {
                      checkboxes[i].checked = true; // If unchecked, check it
                  }
              }
          }
      </script>
