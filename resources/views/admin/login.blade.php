...
<head>
  ...
  <title>Pinyotta - Admin Login</title>
  <!-- General CSS Files -->
  ...
  <link rel='shortcut icon' type='image/x-icon' href='assets_admin/img/favicon.ico' />
</head>
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              <div class="card-header">
                <h4>Pinyotta Admin</h4>
              </div>
              <div class="card-body">
                <form method="POST" action="{{ route('admin.signin') }}" class="needs-validation" novalidate="">
                @csrf
